var calibration = function() {
    ...
    var getCalibration = function() {
        ...
        Communication.get().emit('get.calibration');
        Communication.get().on('get_calibration_evt', function(cal){
            if(cal){
                defer.resolve(cal);
            }
        })
    ...
    var setCalibration = function() {
        ...
        Communication.get().emit('set_calibration_evt', {
    ...
    var startCalibrationState = function() {
        ...
        description.text('');
        rightButton.hide();
        leftButton.text('Démarrer la calibration');
        leftButton.show();
    ...
    var targetCalibrationState = function() {
        clearClickHandlers();
        description.text('Déplacez les ronds rouge pour former un cible. Attentin que la cible soit accessible par le laser.');
        rightButton.text('Suivant');
        leftButton.text('Précédent');
    ...
    var servoCorner1State = function() {
        clearClickHandlers();
        description.text('Utilisez les servos pour diriger vers le rond rouge en surbrillance.');
        rightButton.text('Suivant');
        leftButton.text('Précédent');
        rightButton.click(function() {
